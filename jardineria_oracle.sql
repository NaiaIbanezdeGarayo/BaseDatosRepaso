...
CREATE TABLE Empleados (
  ...
  --Ejercicio 1 b
  constraint emp_codemp_pk PRIMARY KEY (CodigoEmpleado),
...
CREATE TABLE GamasProductos (
  ...
  --Ejercicio 1 c
  DescripcionTexto clob CONSTRAINT DescTxt_ck CHECK (DescTxt_ck=initcap (DescTxt_ck)),
  DescripcionHTML clob CONSTRAINT DescHtml_ck CHECK (DescHtml_ck=initcap (DescHtml_ck)),
  Imagen blob CONSTRAINT img_ck CHECK (img_ck=initcap (img_ck)),
  --Ejercicio 1 b
  constraint gam_gama_pk PRIMARY KEY (Gama)
);
...
CREATE TABLE Clientes (
  ...
  --Ejercicio 1 b
  constraint cli_codcli_pk PRIMARY KEY (CodigoCliente),
...
CREATE TABLE Pedidos (
  ...
  CodigoCliente integer NOT NULL,
  --Ejercicio 1 b
  constraint ped_codped_pk PRIMARY KEY (CodigoPedido),
  CONSTRAINT Pedidos_Cliente FOREIGN KEY (CodigoCliente) REFERENCES Clientes (CodigoCliente)
);
alter session set nls_date_format='yyyy-mm-dd';

INSERT INTO Pedidos VALUES (1,to_date('2006-01-17'),to_date('2006-01-19'),to_date('2006-01-19'),'Entregado','Pagado a plazos',5);
INSERT INTO Pedidos VALUES (2,to_date('2007-10-23'),to_date('2007-10-28'),to_date('2007-10-26'),'Entregado','La entrega llego antes de lo esperado',5);
INSERT INTO Pedidos VALUES (3,to_date('2008-06-20'),to_date('2008-06-25'),NULL,'Rechazado','Limite de credito superado',5);
INSERT INTO Pedidos VALUES (4,to_date('2009-01-20'),to_date('2009-01-26'),NULL,'Pendiente',NULL,5);
INSERT INTO Pedidos VALUES (8,to_date('2008-11-09'),to_date('2008-11-14'),to_date('2008-11-14'),'Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO Pedidos VALUES (9,to_date('2008-12-22'),to_date('2008-12-27'),to_date('2008-12-28'),'Entregado','El cliente comprueba la integridad del paquete, todo correcto',1);
INSERT INTO Pedidos VALUES (10,to_date('2009-01-15'),to_date('2009-01-20'),NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO Pedidos VALUES (11,to_date('2009-01-20'),to_date('2009-01-27'),NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1);
INSERT INTO Pedidos VALUES (12,to_date('2009-01-22'),to_date('2009-01-27'),NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1);
INSERT INTO Pedidos VALUES (13,to_date('2009-01-12'),to_date('2009-01-14'),to_date('2009-01-15'),'entregado',NULL,7);
INSERT INTO Pedidos VALUES (14,to_date('2009-01-02'),to_date('2009-01-02'),null,'rechazado','mal pago',7);
INSERT INTO Pedidos VALUES (15,to_date('2009-01-09'),to_date('2009-01-12'),to_date('2009-01-11'),'entregado',NULL,7);
INSERT INTO Pedidos VALUES (16,to_date('2009-01-06'),to_date('2009-01-07'),to_date('2009-01-15'),'entregado',NULL,7);
INSERT INTO Pedidos VALUES (17,to_date('2009-01-08'),to_date('2009-01-09'),to_date('2009-01-11'),'entregado','mal estado',7);
INSERT INTO Pedidos VALUES (18,to_date('2009-01-05'),to_date('2009-01-06'),to_date('2009-01-07'),'entregado',NULL,9);
INSERT INTO Pedidos VALUES (19,to_date('2009-01-18'),to_date('2009-02-12'),NULL,'pendiente','entregar en murcia',9);
INSERT INTO Pedidos VALUES (20,to_date('2009-01-20'),to_date('2009-02-15'),NULL,'pendiente',NULL,9);
INSERT INTO Pedidos VALUES (21,to_date('2009-01-09'),to_date('2009-01-09'),to_date('2009-01-09'),'rechazado','mal pago',9);
INSERT INTO Pedidos VALUES (22,to_date('2009-01-11'),to_date('2009-01-11'),to_date('2009-01-13'),'entregado',NULL,9);
INSERT INTO Pedidos VALUES (23,to_date('2008-12-30'),to_date('2009-01-10'),NULL,'Rechazado','El pedido fue anulado por el cliente',5);
INSERT INTO Pedidos VALUES (24,to_date('2008-07-14'),to_date('2008-07-31'),'2008-07-25','Entregado',NULL,14);
INSERT INTO Pedidos VALUES (25,to_date('2009-02-02'),to_date('2009-02-08'),NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1);
INSERT INTO Pedidos VALUES (26,to_date('2009-02-06'),to_date('2009-02-12'),NULL,'Rechazado','El cliente anula la operacion para adquirir mas productos',3);
INSERT INTO Pedidos VALUES (27,to_date('2009-02-07'),to_date('2009-02-13'),NULL,'Entregado','El pedido aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO Pedidos VALUES (28,to_date('2009-02-10'),to_date('2009-02-17'),to_date('2009-02-20'),'Entregado','El cliente se queja bastante de la espera asociada al producto',3);
INSERT INTO Pedidos VALUES (29,to_date('2008-08-01'),to_date('2008-09-01'),to_date('2008-09-01'),'Rechazado','El cliente no está conforme con el pedido',14);
INSERT INTO Pedidos VALUES (30,to_date('2008-08-03'),to_date('2008-09-03'),to_date('2008-08-31'),'Entregado',NULL,13);
INSERT INTO Pedidos VALUES (31,to_date('2008-09-04'),to_date('2008-09-30'),to_date('2008-10-04'),'Rechazado','El cliente ha rechazado por llegar 5 dias tarde',13);
INSERT INTO Pedidos VALUES (32,to_date('2007-01-07'),to_date('2007-01-19'),to_date('2007-01-27'),'Entregado','Entrega tardia, el cliente puso reclamacion',4);
INSERT INTO Pedidos VALUES (33,to_date('2007-05-20'),to_date('2007-05-28'),NULL,'Rechazado','El pedido fue anulado por el cliente',4);
INSERT INTO Pedidos VALUES (34,to_date('2007-06-20'),to_date('2008-06-28'),to_date('2008-06-28'),'Entregado','Pagado a plazos',4);
INSERT INTO Pedidos VALUES (35,to_date('2008-03-10'),to_date('2009-03-20'),NULL,'Rechazado','Limite de credito superado',4);
INSERT INTO Pedidos VALUES (36,to_date('2008-10-15'),to_date('2008-12-15'),to_date('2008-12-10'),'Entregado',NULL,14);
INSERT INTO Pedidos VALUES (37,to_date('2008-11-03'),to_date('2009-11-13'),NULL,'Pendiente','El pedido nunca llego a su destino',4);
INSERT INTO Pedidos VALUES (38,to_date('2009-03-05'),to_date('2009-03-06'),to_date('2009-03-07'),'Entregado',NULL,19);
INSERT INTO Pedidos VALUES (39,to_date('2009-03-06'),to_date('2009-03-07'),to_date('2009-03-09'),'Pendiente',NULL,19);
INSERT INTO Pedidos VALUES (40,to_date('2009-03-09'),to_date('2009-03-10'),to_date('2009-03-13'),'Rechazado',NULL,19);
INSERT INTO Pedidos VALUES (41,to_date('2009-03-12'),to_date('2009-03-13'),to_date('2009-03-13'),'Entregado',NULL,19);
INSERT INTO Pedidos VALUES (42,to_date('2009-03-22'),to_date('2009-03-23'),to_date('2009-03-27'),'Entregado',NULL,19);
INSERT INTO Pedidos VALUES (43,to_date('2009-03-25'),to_date('2009-03-26'),to_date('2009-03-28'),'Pendiente',NULL,23);
INSERT INTO Pedidos VALUES (44,to_date('2009-03-26'),to_date('2009-03-27'),to_date('2009-03-30'),'Pendiente',NULL,23);
INSERT INTO Pedidos VALUES (45,to_date('2009-04-01'),to_date('2009-03-04'),to_date('2009-03-07'),'Entregado',NULL,23);
INSERT INTO Pedidos VALUES (46,to_date('2009-04-03'),to_date('2009-03-04'),to_date('2009-03-05'),'Rechazado',NULL,23);
INSERT INTO Pedidos VALUES (47,to_date('2009-04-15'),to_date('2009-03-17'),to_date('2009-03-17'),'Entregado',NULL,23);
INSERT INTO Pedidos VALUES (48,to_date('2008-03-17'),to_date('2008-03-30'),to_date('2008-03-29'),'Entregado','Según el Cliente, el pedido llegó defectuoso',26);
INSERT INTO Pedidos VALUES (49,to_date('2008-07-12'),to_date('2008-07-22'),to_date('2008-07-23'),'Entregado','El pedido llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora',26);
INSERT INTO Pedidos VALUES (50,to_date('2008-03-17'),to_date('2008-08-09'),NULL,'Pendiente','Al parecer, el pedido se ha extraviado a la altura de Sotalbo (�?vila)',26);
INSERT INTO Pedidos VALUES (51,to_date('2008-10-01'),to_date('2008-10-14'),to_date('2008-10-14'),'Entregado','Todo se entregó a tiempo y en perfecto estado, a pesar del pésimo estado de las carreteras.',26);
INSERT INTO Pedidos VALUES (52,to_date('2008-12-07'),to_date('2008-12-21'),NULL,'Pendiente','El transportista ha llamado a Eva María para indicarle que el pedido llegará más tarde de lo esperado.',26);
INSERT INTO Pedidos VALUES (53,to_date('2008-10-15'),to_date('2008-11-15'),to_date('2008-11-09'),'Entregado','El pedido llega 6 dias antes',13);
INSERT INTO Pedidos VALUES (54,to_date('2009-01-11'),to_date('2009-02-11'),NULL,'Pendiente',NULL,14);
INSERT INTO Pedidos VALUES (55,to_date('2008-12-10'),to_date('2009-01-10'),to_date('2009-01-11'),'Entregado','Retrasado 1 dia por problemas de transporte',14);
INSERT INTO Pedidos VALUES (56,to_date('2008-12-19'),to_date('2009-01-20'),NULL,'Rechazado','El cliente a anulado el pedido el dia 2009-01-10',13);
INSERT INTO Pedidos VALUES (57,to_date('2009-01-05'),to_date('2009-02-05'),NULL,'Pendiente',NULL,13);
INSERT INTO Pedidos VALUES (58,to_date('2009-01-24'),to_date('2009-01-31'),to_date('2009-01-30'),'Entregado','TODO CORRECTO',3);
INSERT INTO Pedidos VALUES (59,to_date('2008-11-09'),to_date('2008-11-14'),to_date('2008-11-14'),'Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO Pedidos VALUES (60,to_date('2008-12-22'),to_date('2008-12-27'),to_date('2008-12-28'),'Entregado','El cliente comprueba la integridad del paquete, todo correcto',1);
INSERT INTO Pedidos VALUES (61,to_date('2009-01-15'),to_date('2009-01-20'),NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO Pedidos VALUES (62,to_date('2009-01-20'),to_date('2009-01-27'),NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1);
INSERT INTO Pedidos VALUES (63,to_date('2009-01-22'),to_date('2009-01-27'),NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1);
INSERT INTO Pedidos VALUES (64,to_date('2009-01-24'),to_date('2009-01-31'),to_date('2009-01-30'),'Entregado','TODO CORRECTO',1);
INSERT INTO Pedidos VALUES (65,to_date('2009-02-02'),to_date('2009-02-08'),NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1);
INSERT INTO Pedidos VALUES (66,to_date('2009-02-06'),to_date('2009-02-12'),NULL,'Rechazado','El cliente anula la operacion para adquirir mas productos',3);
INSERT INTO Pedidos VALUES (67,to_date('2009-02-07'),to_date('2009-02-13'),NULL,'Entregado','El pedido aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO Pedidos VALUES (68,to_date('2009-02-10'),to_date('2009-02-17'),to_date('2009-02-20'),'Entregado','El cliente se queja bastante de la espera asociada al producto',3);
INSERT INTO Pedidos VALUES (74,to_date('2009-01-14'),to_date('2009-01-22'),NULL,'Rechazado','El pedido no llego el dia que queria el cliente por fallo del transporte',15);
INSERT INTO Pedidos VALUES (75,to_date('2009-01-11'),to_date('2009-01-13'),to_date('2009-01-13'),'Entregado','El pedido llego perfectamente',15);
INSERT INTO Pedidos VALUES (76,to_date('2008-11-15'),to_date('2008-11-23'),to_date('2008-11-23'),'Entregado',NULL,15);
INSERT INTO Pedidos VALUES (77,to_date('2009-01-03'),to_date('2009-01-08'),NULL,'Pendiente','El pedido no pudo ser entregado por problemas meteorologicos',15);
INSERT INTO Pedidos VALUES (78,to_date('2008-12-15'),to_date('2008-12-17'),to_date('2008-12-17'),'Entregado','Fue entregado, pero faltaba mercancia que sera entregada otro dia',15);
INSERT INTO Pedidos VALUES (79,to_date('2009-01-12'),to_date('2009-01-13'),to_date('2009-01-13'),'Entregado',NULL,28);
INSERT INTO Pedidos VALUES (80,to_date('2009-01-25'),to_date('2009-01-26'),NULL,'Pendiente','No terminó el pago',28);
INSERT INTO Pedidos VALUES (81,to_date('2009-01-18'),to_date('2009-01-24'),NULL,'Rechazado','Los productos estaban en mal estado',28);
INSERT INTO Pedidos VALUES (82,to_date('2009-01-20'),to_date('2009-01-29'),to_date('2009-01-29'),'Entregado','El pedido llego un poco mas tarde de la hora fijada',28);
INSERT INTO Pedidos VALUES (83,to_date('2009-01-24'),to_date('2009-01-28'),NULL,'Entregado',NULL,28);
INSERT INTO Pedidos VALUES (89,to_date('2007-10-05'),to_date('2007-12-13'),to_date('2007-12-10'),'Entregado','La entrega se realizo dias antes de la fecha esperada por lo que el cliente quedo satisfecho',35);
INSERT INTO Pedidos VALUES (90,to_date('2009-02-07'),to_date('2008-02-17'),NULL,'Pendiente','Debido a la nevada caída en la sierra, el pedido no podrá llegar hasta el día ',27);
INSERT INTO Pedidos VALUES (91,to_date('2009-03-18'),to_date('2009-03-29'),to_date('2009-03-27'),'Entregado','Todo se entregó a su debido tiempo, incluso con un día de antelación',27);
INSERT INTO Pedidos VALUES (92,to_date('2009-04-19'),to_date('2009-04-30'),to_date('2009-05-03'),'Entregado','El pedido se entregó tarde debido a la festividad celebrada en España durante esas fechas',27);
INSERT INTO Pedidos VALUES (93,to_date('2009-05-03'),to_date('2009-05-30'),to_date('2009-05-17'),'Entregado','El pedido se entregó antes de lo esperado.',27);
INSERT INTO Pedidos VALUES (94,to_date('2009-10-18'),to_date('2009-11-01'),NULL,'Pendiente','El pedido está en camino.',27);
INSERT INTO Pedidos VALUES (95,to_date('2008-01-04'),to_date('2008-01-19'),to_date('2008-01-19'),'Entregado',NULL,35);
INSERT INTO Pedidos VALUES (96,to_date('2008-03-20'),to_date('2008-04-12'),to_date('2008-04-13'),'Entregado','La entrega se retraso un dia',35);
INSERT INTO Pedidos VALUES (97,to_date('2008-10-08'),to_date('2008-11-25'),to_date('2008-11-25'),'Entregado',NULL,35);
INSERT INTO Pedidos VALUES (98,to_date('2009-01-08'),to_date('2009-02-13'),NULL,'Pendiente',NULL,35);
INSERT INTO Pedidos VALUES (99,to_date('2009-02-15'),to_date('2009-02-27'),NULL,'Pendiente',NULL,16);
INSERT INTO Pedidos VALUES (100,to_date('2009-01-10'),to_date('2009-01-15'),to_date('2009-01-15'),'Entregado','El pedido llego perfectamente',16);
INSERT INTO Pedidos VALUES (101,to_date('2009-03-07'),to_date('2009-03-27'),NULL,'Rechazado','El pedido fue rechazado por el cliente',16);
INSERT INTO Pedidos VALUES (102,to_date('2008-12-28'),to_date('2009-01-08'),to_date('2009-01-08'),'Entregado','Pago pendiente',16);
INSERT INTO Pedidos VALUES (103,to_date('2009-01-15'),to_date('2009-01-20'),to_date('2009-01-24'),'Pendiente',NULL,30);
INSERT INTO Pedidos VALUES (104,to_date('2009-03-02'),to_date('2009-03-06'),to_date('2009-03-06'),'Entregado',NULL,30);
INSERT INTO Pedidos VALUES (105,to_date('2009-02-14'),to_date('2009-02-20'),NULL,'Rechazado','el producto ha sido rechazado por la pesima calidad',30);
INSERT INTO Pedidos VALUES (106,to_date('2009-05-13'),to_date('2009-05-15'),to_date('2009-05-20'),'Pendiente',NULL,30);
INSERT INTO Pedidos VALUES (107,to_date('2009-04-06'),to_date('2009-04-10'),to_date('2009-04-10'),'Entregado',NULL,30);
INSERT INTO Pedidos VALUES (108,to_date('2009-04-09'),to_date('2009-04-15'),to_date('2009-04-15'),'Entregado',NULL,16);
INSERT INTO Pedidos VALUES (109,to_date('2006-05-25'),to_date('2006-07-28'),to_date('2006-07-28'),'Entregado',NULL,38);
INSERT INTO Pedidos VALUES (110,to_date('2007-03-19'),to_date('2007-04-24'),to_date('2007-04-24'),'Entregado',NULL,38);
INSERT INTO Pedidos VALUES (111,to_date('2008-03-05'),to_date('2008-03-30'),to_date('2008-03-30'),'Entregado',NULL,36);
INSERT INTO Pedidos VALUES (112,to_date('2009-03-05'),to_date('2009-04-06'),to_date('2009-05-07'),'Pendiente',NULL,36);
INSERT INTO Pedidos VALUES (113,to_date('2008-10-28'),to_date('2008-11-09'),to_date('2009-01-09'),'Rechazado','El producto ha sido rechazado por la tardanza de el envio',36);
INSERT INTO Pedidos VALUES (114,to_date('2009-01-15'),to_date('2009-01-29'),to_date('2009-01-31'),'Entregado','El envio llego dos dias más tarde debido al mal tiempo',36);
INSERT INTO Pedidos VALUES (115,to_date('2008-11-29'),to_date('2009-01-26'),to_date('2009-02-27'),'Pendiente',NULL,36);
INSERT INTO Pedidos VALUES (116,to_date('2008-06-28'),to_date('2008-08-01'),to_date('2008-08-01'),'Entregado',NULL,38);
INSERT INTO Pedidos VALUES (117,to_date('2008-08-25'),to_date('2008-10-01'),NULL,'Rechazado','El pedido ha sido rechazado por la acumulacion de pago pendientes del cliente',38);
INSERT INTO Pedidos VALUES (118,to_date('2009-02-15'),to_date('2009-02-27'),NULL,'Pendiente',NULL,16);
INSERT INTO Pedidos VALUES (119,to_date('2009-01-10'),to_date('2009-01-15'),to_date('2009-01-15'),'Entregado','El pedido llego perfectamente',16);
INSERT INTO Pedidos VALUES (120,to_date('2009-03-07'),to_date('2009-03-27'),NULL,'Rechazado','El pedido fue rechazado por el cliente',16);
INSERT INTO Pedidos VALUES (121,to_date('2008-12-28'),to_date('2009-01-08'),to_date('2009-01-08'),'Entregado','Pago pendiente',16);
INSERT INTO Pedidos VALUES (122,to_date('2009-04-09'),to_date('2009-04-15'),to_date('2009-04-15'),'Entregado',NULL,16);
INSERT INTO Pedidos VALUES (123,to_date('2009-01-15'),to_date('2009-01-20'),to_date('2009-01-24'),'Pendiente',NULL,30);
INSERT INTO Pedidos VALUES (124,to_date('2009-03-02'),to_date('2009-03-06'),to_date('2009-03-06'),'Entregado',NULL,30);
INSERT INTO Pedidos VALUES (125,to_date('2009-02-14'),to_date('2009-02-20'),NULL,'Rechazado','el producto ha sido rechazado por la pesima calidad',30);
INSERT INTO Pedidos VALUES (126,to_date('2009-05-13'),to_date('2009-05-15'),to_date('2009-05-20'),'Pendiente',NULL,30);
INSERT INTO Pedidos VALUES (127,to_date('2009-04-06'),to_date('2009-04-10'),to_date('2009-04-10'),'Entregado',NULL,30);
INSERT INTO Pedidos VALUES (128,to_date('2008-11-10'),to_date('2008-12-10'),to_date('2008-12-29'),'Rechazado','El pedido ha sido rechazado por el cliente por el retraso en la entrega',38);
...
CREATE TABLE Productos (
  ...
  --Ejercicio 1 b
  constraint prod_codprod_pk PRIMARY KEY (CodigoProducto),
...
CREATE TABLE DetallePedidos (
  ...
  --Ejercicio 1 b
  constraint det_codped_codprod_pk PRIMARY KEY (CodigoPedido,CodigoProducto),
...
CREATE TABLE Pagos (
  ...
  --Ejercicio 1 b
  constraint pag_codcli_id_pk PRIMARY KEY (CodigoCliente,IDTransaccion),
  CONSTRAINT Pagos_clienteFK FOREIGN KEY (CodigoCliente) REFERENCES Clientes (CodigoCliente),
  --Ejercicio 1 e
  CONSTRAINT FPago_ck CHECK (FormaPago IN ('PayPal','Transferencia','Cheque'))
) ;
INSERT INTO Pagos VALUES (1,'PayPal','ak-std-000001',to_date('2008-11-10'),2000);
INSERT INTO Pagos VALUES (1,'PayPal','ak-std-000002',to_date('2008-12-10'),2000);
INSERT INTO Pagos VALUES (3,'PayPal','ak-std-000003',to_date('2009-01-16'),5000);
INSERT INTO Pagos VALUES (3,'PayPal','ak-std-000004',to_date('2009-02-16'),5000);
INSERT INTO Pagos VALUES (3,'PayPal','ak-std-000005',to_date('2009-02-19'),926);
INSERT INTO Pagos VALUES (4,'PayPal','ak-std-000006',to_date('2007-01-08'),20000);
INSERT INTO Pagos VALUES (4,'PayPal','ak-std-000007',to_date('2007-01-08'),20000);
INSERT INTO Pagos VALUES (4,'PayPal','ak-std-000008',to_date('2007-01-08'),20000);
INSERT INTO Pagos VALUES (4,'PayPal','ak-std-000009',to_date('2007-01-08'),20000);
INSERT INTO Pagos VALUES (4,'PayPal','ak-std-000010',to_date('2007-01-08'),1849);
INSERT INTO Pagos VALUES (5,'Transferencia','ak-std-000011',to_date('2006-01-18'),23794);
INSERT INTO Pagos VALUES (7,'Cheque','ak-std-000012',to_date('2009-01-13'),2390);
INSERT INTO Pagos VALUES (9,'PayPal','ak-std-000013',to_date('2009-01-06'),929);
INSERT INTO Pagos VALUES (13,'PayPal','ak-std-000014',to_date('2008-08-04'),2246);
INSERT INTO Pagos VALUES (14,'PayPal','ak-std-000015',to_date('2008-07-15'),4160);
INSERT INTO Pagos VALUES (15,'PayPal','ak-std-000016',to_date('2009-01-15'),2081);
INSERT INTO Pagos VALUES (15,'PayPal','ak-std-000035',to_date('2009-02-15'),10000);
INSERT INTO Pagos VALUES (16,'PayPal','ak-std-000017',to_date('2009-02-16'),4399);
INSERT INTO Pagos VALUES (19,'PayPal','ak-std-000018',to_date('2009-03-06'),232);
INSERT INTO Pagos VALUES (23,'PayPal','ak-std-000019',to_date('2009-03-26'),272);
INSERT INTO Pagos VALUES (26,'PayPal','ak-std-000020',to_date('2008-03-18'),18846);
INSERT INTO Pagos VALUES (27,'PayPal','ak-std-000021',to_date('2009-02-08'),10972);
INSERT INTO Pagos VALUES (28,'PayPal','ak-std-000022',to_date('2009-01-13'),8489);
INSERT INTO Pagos VALUES (30,'PayPal','ak-std-000024',to_date('2009-01-16'),7863);
INSERT INTO Pagos VALUES (35,'PayPal','ak-std-000025',to_date('2007-10-06'),3321);
INSERT INTO Pagos VALUES (38,'PayPal','ak-std-000026',to_date('2006-05-26'),1171);
